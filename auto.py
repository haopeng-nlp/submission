...
class AutoSeq2SeqModelSubmission(object):
    ...
    def prepare(self) -> None:
        ...
        if self._quantize_mode == "bb8" or self._quantize_mode == "bb4":
            raise NotImplementedError("Not all models support `bitsandbytes` quantization so this is not "
        ...
        if self._quantize_mode == "fp16":
            self.model = model_cls.from_pretrained(self._pretrained_model_name_or_path,
